...
export default function SignupPage() {
  ...
  return (
    <div className="flex flex-col min-h-[100dvh] bg-background/50">
      {/* Mobile Top Header (Consistent with Dashboard) */}
      <header className="md:hidden h-14 border-b flex items-center justify-between px-4 glass-panel shrink-0 z-20 bg-card">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <Card className="w-full max-w-md glass-panel border-primary/10">
          <CardHeader className="space-y-2 text-center">
            <CardTitle className="text-2xl font-bold mt-2">{t.auth.signupTitle}</CardTitle>
            <CardDescription>
